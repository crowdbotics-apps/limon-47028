"""
Django settings for limon_47028 project.
...
WSGI_APPLICATION = 'limon_47028.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "limon_47028 API",
    "DESCRIPTION": "API documentation for limon_47028 App",
    "VERSION": "v1",
}
